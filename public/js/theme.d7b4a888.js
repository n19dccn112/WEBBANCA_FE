...
$(function () {
    ...
    //   Circle Slider
    // ------------------------------------------------------ //
    var circleSlider = $(".circle-FilterBar.js");
    circleSlider
        .on({
    ...
    //   Home Slider
    // ------------------------------------------------------ //
    var homeSlider = $(".home-FilterBar.js");
    ...
    var homeFullSlider = $(".home-full-FilterBar.js");
    ...
    //   Product Slider
    // ------------------------------------------------------ //
    $(".product-FilterBar.js").owlCarousel({
        loop: false,
        margin: 0,
        nav: false,
        dots: true,
    ...
    // ------------------------------------------------------ //
    $(".detail-FilterBar.js").owlCarousel({
        loop: true,
        items: 1,
        thumbs: true,
    ...
    var brandsSlider = $(".brands-FilterBar.js");
